...
2. Create a file named `.env` in the root directory of this project (`submissions/` will be considered the root directory).
...
1. `cd` into the root directory (`submissions/`).
